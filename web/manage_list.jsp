...
.type03 a:active { color: black; }
.type03 a:link { color: black; }
.type03k a:visited { color: black; }
...
<body>
	...
	<div class="mainLeft"  style=" height:700px;">
		...
		<p><button id="export">Excel다운</button></p>
		...
		<form method="post" action="manage_list.jsp?&club_id=<%=club_id%>">
				<ul class ="search_list" style="text-align:center">
					<li><select name="category">
							<option value="nm" <%if (category.equals("nm")) out.println("selected"); %>>이름</option>
							<option value="major" <%if (category.equals("major")) out.println("selected"); %>>전공</option>
							<option value="student_id" <%if (category.equals("student_id")) out.println("selected"); %>>학번</option>
					</select></li>
